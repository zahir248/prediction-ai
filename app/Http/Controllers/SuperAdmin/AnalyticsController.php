...
class AnalyticsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Superadmin gets system-wide analytics (no organization filter)
        $analytics = $this->analyticsService->getSystemAnalytics($startDate, $endDate, null);
    ...
    public function export(Request $request)
    {
        ...
        // Generate CSV export
        $filename = 'system_analytics_' . $startDate->format('Y-m-d') . '_to_' . $endDate->format('Y-m-d') . '.csv';
