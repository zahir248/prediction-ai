        ...
        <div class="card-header bg-white border-0 py-3">
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center">
                <h5 class="card-title mb-0 fw-semibold">
                    <i class="bi bi-graph-up text-primary me-2"></i>All Predictions
                </h5>
                            ...
                            <tr data-prediction-id="{{ $prediction->id }}" data-user-id="{{ $prediction->user->id }}" data-user-role="{{ $prediction->user->role }}">
                                ...
                                <td class="px-3 py-3">
                                    <div class="btn-group" role="group">
                                        ...
                                        <button class="btn btn-outline-primary btn-sm" onclick="deletePrediction({{ $prediction->id }})" title="Delete Prediction">
