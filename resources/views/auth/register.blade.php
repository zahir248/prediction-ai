...
<div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 48px 16px;">
    <div style="max-width: 420px; width: 100%;">
        ...
        <div style="text-align: center; margin-bottom: 40px;">
            ...
            <p style="color: rgba(255, 255, 255, 0.8); font-size: 16px;">Create your account</p>
        </div>
        ...
        <div style="background: white; border-radius: 20px; padding: 40px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); backdrop-filter: blur(10px);">
            <form action="{{ route('register') }}" method="POST">
                ...
                <div style="margin-bottom: 24px;">
                    <label for="name" style="display: block; margin-bottom: 8px; font-weight: 600; color: #374151; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px;">
                        Full Name
                    </label>
                ...
                <div style="margin-bottom: 32px;">
                    <label for="password_confirmation" style="display: block; margin-bottom: 8px; font-weight: 600; color: #374151; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px;">
                        Confirm Password
                    </label>
                    <div style="position: relative;">
                ...
                @if ($errors->any())
                    <div style="background: #fef2f2; border: 1px solid #fecaca; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
                        <div style="display: flex; align-items: center; margin-bottom: 8px;">
                            ...
                            <span style="font-weight: 600; color: #991b1b; font-size: 14px;">Registration Error</span>
                        </div>
                ...
                <div style="text-align: center; padding-top: 24px; border-top: 1px solid #f3f4f6;">
                    <p style="color: #6b7280; font-size: 14px; margin-bottom: 8px;">Already have an account?</p>
                    <a href="{{ route('login') }}" style="color: #667eea; text-decoration: none; font-weight: 600; font-size: 14px; transition: color 0.3s ease; text-transform: uppercase; letter-spacing: 0.5px;">
                        Sign In ←
                    </a>
                </div>
            </form>
