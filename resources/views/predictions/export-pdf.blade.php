...
<body>
    <div class="header">
        ...
        <p style="color: #059669; font-weight: bold; margin: 8px 0; text-align: center;">Target Focus: {{ $prediction->target }}</p>
        @endif
        <p style="text-align: center;">Generated on {{ date('F d, Y \a\t g:i A') }}</p>
    </div>
    ...
    <div class="section major-section">
        ...
        <div class="prediction-content">
            ...
            <p>This comprehensive analysis provides detailed insights into the prediction results generated by our NUJUM system. The analysis covers key findings, risk assessments, and strategic recommendations based on the input data and NUJUM-generated predictions.</p>
            
            @if($prediction->status === 'completed' && $prediction->prediction_result)
                @if(isset($prediction->prediction_result['executive_summary']))
                    <div class="highlight-box">
                        <strong>NUJUM-Generated Summary:</strong><br>
    ...
    <div class="section major-section">
        ...
        <div class="prediction-content">
            ...
            <h3>Data Context</h3>
            <p>This analysis is based on the provided input data and leverages advanced NUJUM algorithms to generate comprehensive predictions and insights. The system processes multiple data points to identify patterns, risks, and opportunities.</p>
        </div>
    </div>
    ...
    <div class="section major-section">
        ...
        <div class="prediction-content">
            ...
            <p>These sources were referenced during the NUJUM analysis to provide additional context and data points for the prediction. The analysis incorporates information from both the user input and these external sources.</p>
        </div>
    </div>
    @endif
    ...
    @if($prediction->status === 'completed' && $prediction->prediction_result)
        <div class="section major-section force-break">
            <div class="section-title">NUJUM Analysis Results</div>
            ...
            @if(isset($prediction->prediction_result['title']) && is_string($prediction->prediction_result['title']))
                                ...
                                <li style="margin-bottom: 12px; text-align: justify;">
                                    ...
                                    @elseif(is_array($factor))
                                        ...
                                        @foreach($factor as $key => $value)
                                            @if(is_string($value))
                                                <div style="text-align: justify;"><strong>{{ ucfirst(str_replace('_', ' ', $key)) }}:</strong> {!! convertMarkdownBold($value) !!}</div>
                                            @elseif(is_array($value))
                ...
                @if(isset($report['critical_timeline']) || isset($report['next_review']) || isset($report['analysis_date']))
                    <div class="prediction-content avoid-break" style="border-left: 3px solid #ff9800;">
                        ...
                        @endif
                        <p><strong>Analysis Date:</strong> {{ $prediction->created_at->format('Y-m-d') }}</p>
                        <p><strong>Next Review Date:</strong> {{ $prediction->created_at->copy()->addMonth()->format('Y-m-d') }}</p>
                    </div>
                @endif
            @else
                <div class="prediction-content">
    ...
    @elseif($prediction->status === 'failed')
        <div class="section major-section">
            ...
            <div class="prediction-content" style="border-left: 3px solid #f44336; color: #c62828;">
                ...
                <p>The NUJUM prediction analysis could not be completed. Please try again or contact support.</p>
            </div>
        </div>
    @else
        <div class="section major-section">
            ...
            <div class="prediction-content" style="border-left: 3px solid #ff9800; color: #ef6c00;">
                <h3>Processing...</h3>
                <p>Your prediction analysis is being processed by NUJUM. This may take a few moments.</p>
            </div>
        </div>
    @endif
    ...
    <div class="section major-section">
        ...
        <div class="info-grid">
            ...
            <div class="info-row">
                ...
                <div class="info-value">NUJUM-powered pattern recognition and predictive modeling</div>
            </div>
            <div class="info-row">
